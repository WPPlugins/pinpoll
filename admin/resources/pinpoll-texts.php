...
function pinpoll_get_dashboard_texts() {
  return array(
    ...
    'error' => __( 'Fatal error: Our server could not complete the request. Please refresh page!', 'pinpoll' ),
...
function pinpoll_get_accountstatus_texts() {
  return array(
    ...
    'error' => __( 'Fatal Error: our server could not complete the request. Please refresh page. If problems persist, please contact: support@pinpoll.com', 'pinpoll' ),
    'errorfatal' => __( 'Fatal Error: our server could not complete the request. If problems persist, please contact: support@pinpoll.com', 'pinpoll' ),
